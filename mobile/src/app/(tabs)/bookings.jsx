...
export default function BookingsScreen() {
  ...
  const { selectedTab, setSelectedTab, showReceipt, isReceiptVisible } = useBookingUIStore();
  ...
  // Use Convex bookings if available, otherwise fallback to store
  const bookings = convexBookings.length > 0 ? convexBookings : storeBookings;
  const isLoading = convexLoading || storeLoading;
  const error = convexError || storeError;
        ...
        <View style={{ padding: 16 }}>
          ...
          >
            <View style={{ flex: 1 }}>
              ...
              >
                Booking ID: {booking._id ? booking._id.slice(-8).toUpperCase() : booking.id}
              </Text>
            </View>
            <View
              style={{
