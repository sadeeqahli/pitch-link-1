  ...
  const handleContactSupport = async (method) => {
    switch (method) {
      case "phone":
        ...
        break;
      case "email":
        const email = "support@pitchlink.ng";
        const subject = "Support Request - PitchLink Owner App";
      ...
      case "whatsapp":
        ...
        const message = "Hi, I need help with the PitchLink Owner app.";
        await Linking.openURL(
      ...
      >
        ...
        <View style={{ paddingHorizontal: 24, paddingTop: 8 }}>
          ...
          <SupportCard
            ...
            color="#6366F1"
            onPress={() => {
              Linking.openURL("https://pitchlink.com/docs");
            }}
          />
        </View>
          ...
          >
            ...
            <View style={{ alignItems: "center" }}>
              ...
              <View style={{ flexDirection: "row", gap: 16 }}>
                <TouchableOpacity
                  onPress={() =>
                    Linking.openURL("https://pitchlink.com/privacy")
                  }
                >
                  <Text
                    style={{
                ...
                <TouchableOpacity
                  onPress={() =>
                    Linking.openURL("https://pitchlink.com/terms")
                  }
                >
                  <Text
                    style={{
