...
export default function Pitches() {
  ...
  const fetchPitches = async () => {
    try {
      ...
      const mockPitches = [
        {
          id: 1,
          name: "Green Field Pitch A",
          location: "Lagos Main Stadium",
          description: "Professional football pitch with excellent grass quality and floodlights",
          price_per_hour: 50000,
          is_active: true,
          photos: [
            "https://images.unsplash.com/photo-1560272564-c83ca6a61f5f?w=400&h=300&fit=crop",
            "https://images.unsplash.com/photo-1549842616-08a4b0d3a2a7?w=400&h=300&fit=crop"
          ],
          amenities: ["Floodlights", "Changing Rooms", "Parking", "Restrooms", "Canteen"]
        },
        {
          id: 2,
          name: "Blue Moon Pitch B",
          location: "Victoria Island Sports Complex",
          description: "Well-maintained pitch with synthetic turf, perfect for all weather conditions",
          price_per_hour: 40000,
          is_active: false,
          photos: [
            "https://images.unsplash.com/photo-1511882150382-421056c89033?w=400&h=300&fit=crop"
          ],
          amenities: ["Floodlights", "Changing Rooms", "Parking", "Restrooms"]
        }
      ];
  ...
  const togglePitchStatus = async (pitchId, currentStatus) => {
    try {
      // Mock API call
      console.log(`Toggling pitch ${pitchId} status to ${!currentStatus}`);
      setPitches(
        pitches.map((pitch) =>
          pitch.id === pitchId
          ...
          {pitches.length > 0 ? (
            ...
            >
              ...
              <TouchableOpacity
                ...
                onPress={() => console.log("Add first pitch")}
              >
